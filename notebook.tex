...
$B,H,M$
ופרמאביליות}{השדות B,H,M ופרמאביליות}}
בחומר שבו
$\vec{M}=\chi\vec{H}$
(
$\chi$
...
\item שתי סדרות פרמאביליות הריק לינאריות פנימית אך $\mu_0^{\mathrm{fit}}/\mu_0^{\mathrm{theo}}\approx0.7$ במובהקות גבוהה (טבלה~\ref{tab:mu0-fit-results}); הסבר אפשרי הוא שטף/חתך אפקטיבי קטן מהגאומטרי, או רווח אפקטיבי גדול מהנומינלי.
...
בשדה אפס פרמטר הסדר נעלם בחדות ב-$T_{\mathrm{c}}$; בשדה סופי המגנטיזציה המושרת לא מתאפסת בדיוק במעבר והמעבר מתרחב (איור~\ref{fig:curie-finite-field-schematic}).
...
\end{equation}
עם $c_H,c_Y$ קבועי סקאלה לכל סדרה. איורי הנתונים הגולמיים בוולטים, ואחרי ההמרה ב-$H^*,M^*$. במסמך זה נסמן ב-$T_c$ את טמפרטורת חצי־הגובה של מדד המגנוט המנורמל שנמדדה בשדה סופי.
